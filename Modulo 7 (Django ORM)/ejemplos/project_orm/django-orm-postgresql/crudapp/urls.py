...
from .views import insertar_emp, mostrar_emp, editar_emp, eliminar_emp, actualizarempleado, empleado_detalle, InicioPageView, AcercaPagueView
...
urlpatterns = [
    ...
    path('acerca-de/', AcercaPagueView.as_view(), name='acerca-de'),
]
