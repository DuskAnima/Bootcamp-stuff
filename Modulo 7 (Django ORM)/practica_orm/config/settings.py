...
SECRET_KEY = 'django-insecure-@%%=na!s9kqe^z$6ex$4a0_nm^jvh1wraeby!zvfb4sj@h-qo-'
...
# GRANT USAGE, CREATE ON SCHEMA public TO user_db;

#Probar si también son necesarios:
